...
$(document).ready(function(){
    ...
    $("#addcreditpage").addClass("left_menu_sel");
    ...
    $("#submitBtn").live("click",function(){
		...
		$.post("/cust/addcredit.html", {
				...
				alert(obj.msg);
				if (obj.success == "true") {
	                document.location.href="/cust/creditinfo.html?user_id="+obj.user_id+"&time="+new Date();
				}else{
				    ajax_flag = 0;
				}
		}).error(function(){
...
<div id="center" data-options="region:'center',border:false,style:{borderWidth:0}" style="padding:0px;background:#FFF;">
    <div style="height:41px;line-height:41px;width:90%;font-size:16px;border-bottom:solid #FFF 1px;margin:0px 40px 10px 0px;border-bottom:solid 1px #DDD;">
	    <div style="float:left;margin-left:20px;" >新建挂账用户</div>
    </div>
    <div style="font-size:18px;padding-left:20px;">
        ...
        <div style="line-height:30px;"><input id="credit" type="text" class="cust_input"/>&nbsp;&nbsp;&nbsp;元<span id="credit_err" class="err_msg"></span></div>
